...
class Wp_Faker {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp_Faker_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wp_Faker_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Faker_i18n. Defines internationalization functionality.
	 * - Wp_Faker_Admin. Defines all hooks for the admin area.
	 * - Wp_Faker_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wp_Faker_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
